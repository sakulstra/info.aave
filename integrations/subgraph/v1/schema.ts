...
export interface QueryRequest{
    ...
    block?: (Block_height | null),
    /** Set to `allow` to receive data even if the subgraph has skipped over errors while syncing. */
    subgraphError: _SubgraphErrorPolicy_},UserBorrowHistoryItemRequest]
...
block?: (Block_height | null),
/** Set to `allow` to receive data even if the subgraph has skipped over errors while syncing. */
subgraphError: _SubgraphErrorPolicy_}) => UserBorrowHistoryItemPromiseChain & {get: <R extends UserBorrowHistoryItemRequest>(request: R, defaultValue?: (FieldsSelection<UserBorrowHistoryItem, R> | undefined)) => Promise<(FieldsSelection<UserBorrowHistoryItem, R> | undefined)>}),
...
block?: (Block_height | null),
/** Set to `allow` to receive data even if the subgraph has skipped over errors while syncing. */
subgraphError: _SubgraphErrorPolicy_}) => {get: <R extends UserBorrowHistoryItemRequest>(request: R, defaultValue?: FieldsSelection<UserBorrowHistoryItem, R>[]) => Promise<FieldsSelection<UserBorrowHistoryItem, R>[]>}),
...
block?: (Block_height | null),
/** Set to `allow` to receive data even if the subgraph has skipped over errors while syncing. */
subgraphError: _SubgraphErrorPolicy_}) => UserBorrowHistoryItemObservableChain & {get: <R extends UserBorrowHistoryItemRequest>(request: R, defaultValue?: (FieldsSelection<UserBorrowHistoryItem, R> | undefined)) => Observable<(FieldsSelection<UserBorrowHistoryItem, R> | undefined)>}),
    userBorrowHistoryItems: ((args: {skip?: (Scalars['Int'] | null),first?: (Scalars['Int'] | null),orderBy?: (UserBorrowHistoryItem_orderBy | null),orderDirection?: (OrderDirection | null),where?: (UserBorrowHistoryItem_filter | null),
/** The block at which the query should be executed. Can either be a `{ hash: Bytes }` value containing a block hash, a `{ number: Int }` containing the block number, or a `{ number_gte: Int }` containing the minimum block number. In the case of `number_gte`, the query will be executed on the latest block only if the subgraph has progressed to or past the minimum block number. Defaults to the latest block when omitted. */
block?: (Block_height | null),
/** Set to `allow` to receive data even if the subgraph has skipped over errors while syncing. */
subgraphError: _SubgraphErrorPolicy_}) => {get: <R extends UserBorrowHistoryItemRequest>(request: R, defaultValue?: FieldsSelection<UserBorrowHistoryItem, R>[]) => Observable<FieldsSelection<UserBorrowHistoryItem, R>[]>}),
    userReserve: ((args: {id: Scalars['ID'],
/** The block at which the query should be executed. Can either be a `{ hash: Bytes }` value containing a block hash, a `{ number: Int }` containing the block number, or a `{ number_gte: Int }` containing the minimum block number. In the case of `number_gte`, the query will be executed on the latest block only if the subgraph has progressed to or past the minimum block number. Defaults to the latest block when omitted. */
block?: (Block_height | null),
/** Set to `allow` to receive data even if the subgraph has skipped over errors while syncing. */
